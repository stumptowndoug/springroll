                    ...
                    .superRefine((credential, context) => {
                      if (
                        ...
                        context.addIssue({
                          ...
                          path: ["header"],
                          message:
                            "API credentials can use a header or query injection rail, never both",
                        });
                      }
                      if (
