...
- [ ] Prepare the first GitHub beta release and public source checkpoint
  ...
  - [ ] Candidate 3 in `desktop/dist/release-tsD6yJ/` is signed and awaiting Apple notarization (`a8a6dea0-66ae-48a3-8cb6-a524f3e7cadc`). Private v0.1.0 draft created; clean-account and update-persistence acceptance remain pending.
