...
1. Download the DMG from [v0.1.2](https://github.com/stumptowndoug/springroll/releases/tag/v0.1.2) and open it.
...
[v0.1.2 beta](https://github.com/stumptowndoug/springroll/releases/tag/v0.1.2).
