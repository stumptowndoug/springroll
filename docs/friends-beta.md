...
1. Download the DMG from [v0.1.3](https://github.com/stumptowndoug/springroll/releases/tag/v0.1.3) and open it.
...
[v0.1.3 beta](https://github.com/stumptowndoug/springroll/releases/tag/v0.1.3).
