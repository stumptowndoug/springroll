...
The R2 application host uses loopback port `16441`; storage root, endpoint, host, and port remain overrideable through Rivet environment variables. This is an interim Bun-host lifecycle for development. The Tauri ownership requirements below still apply before packaging.
